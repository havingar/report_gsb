...
$string['automedalxp'] = 'Do you want to automatically award auto calculated medals when a teacher or administrator enters a course';$string['automedal'] = 'Automatic Awards';
$string['crondisable'] = 'Disable Cron';
$string['crondisablexp'] = 'If you do not want to run the house keeping tasks disable this action';
